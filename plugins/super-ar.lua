...
local function run(msg, matches)
    ...
    elseif msg.to.type == 'channel'then
        if matches[1] == 'ترقيه سوبر' then
            ...
            return "⇣ ┇الــمــجــمــوعــه خــارقــه┇ ⚠️✅┇بــل فــعــل┇🌟"
        end
    end
