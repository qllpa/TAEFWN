...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
   local text = ' ⇣ تـ{☑️}ـم 🌟تــفــعــیــل⭐️ الـــبـــوت☂⇣\n'..msg.to.title
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
      local text = '⇣تـ{✅}ـم 💢تــعــطــیــل💢الــبــوت🚸⇣\n'..msg.to.title
      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local title ="🔰مــعــلــومــات عــن الــکـــروب⚠️ :\n"..result.title.."\n\n"
local admin_num = "⁉️عــدد الــادمــنـــیـــة♻️ :\n"..result.admins_count.."\n"
local user_num = "🎈عـــدد الـــاعــضـــاء👁‍:\n"..result.participants_count.."\n"
local kicked_num = "⚠️عــدد الــعــضــاء الـاقــل تـفـاعــلـا💤 :\n"..result.kicked_count.."\n"
local channel_id = "ایـــديــے❇️الــمــجـمـوعــة :\n"..result.peer_id.."\n"
if result.username then
	channel_username = "یــوزر الـــکــروب🚸 :\n@"..result.username
else
 channel_username = ""
end
...
local text = "اعــضـــاء ♻️الــکــروب\n"..cb_extra.receiver
local i = 1
for k,v in pairsByKeys(result) do
...
--vardump(result)
local text = "قــائــمــة ایــدیــات الـاعـضـاء👁‍🗨"..cb_extra.receiver.."\n\n"
local i = 1
for k,v in pairsByKeys(result) do
if not v.print_name then
    name = " "
...
local group_ads_lock = data[tostring(target)]['settings']['lock_ads']
  if group_ads_lock == 'yes' then
    return 'تـــم ☑️ قــفـــل 🔐 الــروابـــط هــنــا✅\n| '..msg.to.title..' |\n  (t.me/..msg.from.username..or 'لا يوجد')#38FF00\n'
  else
    data[tostring(target)]['settings']['lock_ads'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تــــم ✅ قـــفــــل 🔐 الــــروابـــط بـــنـــجـــاح☑️\n| '..msg.to.title..'  (t.me/..msg.from.username..or 'لا يوجد')\n'
  end
end
...
local function unlock_group_ads(msg, data, target)
  ...
  if group_ads_lock == 'no' then
    return 'تـــم ✅ فـــتـــح 🔐الـــروابــــط 🎈 لـــا تـــلــح😑 \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
  else
    data[tostring(target)]['settings']['lock_ads'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تـــم ✅فـــتـــح 🔓 الــروابــــط هــــنــا🎈\n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
end
--------------------------------
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'yes' then
    return 'تـــم✅قـــفــــل🔐 الــــکـــــلایـــــش هــــنــــا🎈 \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    data[tostring(target)]['settings']['lock_spam'] = 'yes'
    save_data(_config.moderation.data, data)
    return ' تـــم ☑️قـــفــــل🔐 الـــکـــلایـــش بـــنــجـــاح🌟\n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    return 'تــــم☑️فـــتـــح 🔓الـــکـــــلایــــش لـــاتـــلــح \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    data[tostring(target)]['settings']['lock_spam'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تـــــم✅فـــتــح 🔓الــکـــلایـــش هــــنــــا \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
end
---------------------------------
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'yes' then
    return 'تــــم☑️قـــفـــل الـــتـــکـــرار ⭐️لــاتـــلـــح🎈 \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    data[tostring(target)]['settings']['flood'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'تـــم✅قـــفــل الـــتــکـــرار🌟هـــنـــا🎈 \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'no' then
    return 'تـــم☑️فـــتــــح الــتـــکــرار🌟لـــاتـــلـــح \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    data[tostring(target)]['settings']['flood'] = 'no'
    save_data(_config.moderation.data, data)
    return 'تــــم فـــتـــح الـــتـــکــرار🌟هـــنــــا\n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
end
---------------------------------
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    return 'تــــم✅قـــفــل الـلــغــة الــعــربـیـة لــا تــلـــح🎈 \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
...
if matches[1] == 'قفل' and is_momod(msg) then
   ...
   local msg_type = 'Photo'
    if not is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
     mute(chat_id, msg_type)
    return '#تـمـ☑️ قـفـلـ #الـصـور فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    return '#الـصـور بـالـتـاكـيـد #تـمـ☑️ قـفـلـهـا فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
   end
   ...
   local msg_type = 'Gifs'
    if not is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
     mute(chat_id, msg_type)
    return '#تـمـ☑️ قـفـلـ #الـمـتـحـركـه فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    return '#الـمـتـحـركـه بـالـتـاكـيـد #تـمـ☑️ قـفـلـهـا فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
            end
   ...
   local msg_type = 'Documents'
    if not is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
     mute(chat_id, msg_type)
    return '#تـمـ☑️ قـفـلـ #الـفـايـلـاتـ فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    return '#الـفـايـلـاتـ بـالـتـاكـيـد #تـمـ☑️ قـفـلـهـا فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
            end
   ...
   local msg_type = 'Text'
    if not is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
     mute(chat_id, msg_type)
    return '#تـمـ☑️ قـفـلـ #الـدردشـه فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    return '#الـدردشـه بـالـتـاكـيـد #تـمـ☑️ قـفـلـهـا فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
            end
   ...
   local msg_type = 'All'
    if not is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
     mute(chat_id, msg_type)
    return ' #تـمـ☑️ قـفـلـ | '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
                else
    return '| '..msg.to.title..' | بـالـتـاكـيـد #تـمـ☑️ قـفـلـهـا\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
                end
            end
        end
  if matches[1] == 'فتح' and is_momod(msg) then
   ...
   local msg_type = 'Photo'
    if is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
     unmute(chat_id, msg_type)
    return '#تـمـ⚠️ فـتـحـ #الـصـور فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    return '#الـصـور بـالـتـاكـيـد #تـمـ⚠️ فـتـحـهـا فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
            end
   if matches[2] == 'الفيديو' then
   local msg_type = 'Video'
   ...
   local msg_type = 'Gifs'
    if is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
     unmute(chat_id, msg_type)
    return '#تـمـ⚠️ فـتـحـ #الـمـتـحـركـه فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    return '#الـمـتـحـركـه بـالـتـاكـيـد #تـمـ⚠️ فـتـحـهـا فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
            end
   if matches[2] == 'الفايلات' then
   local msg_type = 'Documents'
    if is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
     unmute(chat_id, msg_type)
    return '#تـمـ⚠️ فـتـحـ #الـفـايـلـاتـ فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    return '#الـفـايـلـاتـ بـالـتـاكـيـد #تـمـ⚠️ فـتـحـهـا فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
            end
   if matches[2] == 'الدردشه' then
   local msg_type = 'Text'
    if is_muted(chat_id, msg_type..': yes') then
     ...
     unmute(chat_id, msg_type)
    return '#تـمـ⚠️ فـتـحـ #الـدردشـه فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    else
    return '#الـدردشـه بـالـتـاكـيـد #تـمـ⚠️ فـتـحـهـا فـي \n| '..msg.to.title..' |\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
    end
            end
   if matches[2] == 'المجموعه' then
   local msg_type = 'All'
    if is_muted(chat_id, msg_type..': yes') then
     savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
     unmute(chat_id, msg_type)
    return '#تـمـ☑️ فـتـحـ | '..msg.to.title..' | \n#بواسطه |❗️|(@'..(msg.from.username or 'لا يوجد')..')\n'
                else
    return '| '..msg.to.title..' | بـالـتـاكـيـد #تـمـ ⚠️ فـتـحـهـا\n#بواسطه |❗️| (@'..(msg.from.username or 'لا يوجد')..')\n'
                end
   end
  end
